...
import com.example.chat.websocket.config.MockUserPrincipal;
...
public class WebSocketTests {
    ...
    void sendWebSocketMessage_shouldSaveToDatabase_andBroadcastToTopic() {
        ...
        request.setContent("Realtime WebSocket Message Test");

        webSocketController.handleMessage(chatId, request, new MockUserPrincipal("1"));
